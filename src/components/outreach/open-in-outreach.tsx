  ...
  return (
    <>
      ...
      <Dialog
        ...
        description={items.length ? "Choose the opportunity; they join its Selected recipients. Nothing is sent until you compose." : "No opportunities are in play yet. Save one from Funding Notices first."}
        footer={
          <>
