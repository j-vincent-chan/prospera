 ...
 * and order (decision N1): Home, PI Match, PI Outreach, Notice Board, More. PI
 * Match took Calendar's slot: the Review handoff (§0) put it second in the nav
 * with the undecided count, and it is the screen the strategist opens every
 * day, while Calendar moved into "More" with everything else the sidebar
 * lists. Touch targets are 44px. "More" opens a sheet over the bar rather than
 * a page, so nothing the desktop nav reaches is unreachable on a phone.
 */
const TABS = [
  { href: "/home", label: "Home", d: "m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z M9 22V12h6v10", badge: undefined },
  { href: "/review", label: "PI Match", d: "m3 17 2 2 4-4 M3 7l2 2 4-4 M13 6h8 M13 12h8 M13 18h8", badge: "review" as const },
  { href: "/outreach", label: "PI Outreach", d: "m22 2-7 20-4-9-9-4z M22 2 11 13", badge: "outreach" as const },
  { href: "/opportunities", label: "Notice Board", d: "M11 19a8 8 0 1 0 0-16 8 8 0 0 0 0 16z m10 2-4.3-4.3", badge: undefined },
];
...
export function MobileTabBar({ badges = NO_BADGES }: { badges?: SidebarBadges }) {
  ...
  return (
    <>
      ...
      <nav className="fixed inset-x-0 bottom-0 z-40 grid grid-cols-5 border-t border-line bg-card pb-3.5 pt-2 md:hidden" aria-label="Primary">
        {TABS.map((t) => {
