...
export type BlindPassFixture = {
  ...
  notice: { number: string; title: string; activity_code: string | null; clinical_trial_designation: string; issuing_ic?: string | null; nih_ic_tokens?: string[]; topic_terms: string[]; rcdc: string[]; mesh_names?: string[]; sections: NoticeSection[] };
};
